export type Field = { name: string; label: string; type: string; default?: string; options?: string[]; min?: number; max?: number; unit?: string };
...
export type Page = { id: string; title: string; path: string; draft: boolean; template: string; revision: string; file: string };
